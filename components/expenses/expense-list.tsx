        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50 border-b border-slate-200">
              <TableHead className="font-semibold text-slate-700 min-w-45">
                Expense Name
              </TableHead>
              <TableHead className="font-semibold text-slate-700 min-w-25">
                Amount
              </TableHead>
              <TableHead className="font-semibold text-slate-700 min-w-27.5">
                Date
              </TableHead>
              <TableHead className="font-semibold text-slate-700 text-right pr-6 min-w-22.5">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
